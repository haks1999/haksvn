...
insert into code (code_seq, code_group, code_name, code_value, code_order) values (5,'request_type_code', 'normal', '00', 10 );
insert into code (code_seq, code_group, code_name, code_value, code_order) values (6,'request_type_code', 'emergency', '01', 20 );
insert into code (code_seq, code_group, code_name, code_value, code_order) values (7,'common_boolean_yn_code', 'Y', 'true', 10 );
insert into code (code_seq, code_group, code_name, code_value, code_order) values (8,'common_boolean_yn_code', 'N', 'false', 20 );
...
insert into users(user_seq, user_id, user_name, active, email, user_passwd ) values (1,'admin','administrator','Y','admin@gmail.com','admin');