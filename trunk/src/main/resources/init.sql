...
insert into repositories (repository_seq, repository_location, active, repository_name, trunk_path, tags_path, auth_user_id, auth_user_passwd ) values (2,'svn://localhost/svn', 'common.boolean.yn.code.y', 'test none-exist', '/trunk', '/tags', 'admin', 'admin' );
