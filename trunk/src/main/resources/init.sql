...
insert into repositories (repository_seq, repository_location, active, repository_name, svn_name, trunk_path, tags_path, branches_path, auth_user_id, auth_user_passwd, sync_user ) values (1,'https://haksvn.googlecode.com/svn', 'common.boolean.yn.code.y', 'haksvn google repository', 'svn', '/trunk', '/tags', '/branches/production', 'haks1999', 'aW9fj8bm9Rt5','common.boolean.yn.code.n' );
insert into repositories (repository_seq, repository_location, active, repository_name, svn_name, trunk_path, tags_path, branches_path, auth_user_id, auth_user_passwd, sync_user, connect_type, server_ip, user_id, user_passwd, authz_path, passwd_path, passwd_type) values (2,'https://localhost/svn/main/haksvn', 'common.boolean.yn.code.y', 'test local repository', 'main', '/trunk', '/tags', '/branches/production', 'haks1999', 'haks1999','common.boolean.yn.code.y', 'server.connect.type.code.local', null, null, null, 'D:\MyDev\haks1999\repositories\authz', 'D:\MyDev\haks1999\repositories\htpasswd', 'svn.passwd.type.code.md5-apache' );
