...
insert into repositories (repository_seq, repository_location, active, repository_name, trunk_path, tags_path, auth_user_id, auth_user_passwd, sync_user, connect_type, server_ip, user_id, user_passwd, authz_path, passwd_path, passwd_type) values (2,'https://localhost/svn/main', 'common.boolean.yn.code.y', 'test local repository', '/trunk', '/tags', 'haks1999', 'haks1999','common.boolean.yn.code.y', 'server.connect.type.code.local', null, null, null, 'c:\ss', 'c:\aa', 'svn.passwd.type.code.md5-apache' );
